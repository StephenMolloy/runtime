...
namespace System.Runtime.Serialization
{
    ...
    internal static class DataContractExtensions
    {
        internal static DataContractType GetContractType(this DataContract dataContract) => dataContract.ContractType switch
        {
            ...
            "NullableCollectionDataContract" => DataContractType.CollectionDataContract,
        ...
        internal static bool IsCollectionItemNullable(this DataContract collectionDataContract) => (collectionDataContract.ContractType == "NullableCollectionDataContract");
    }
