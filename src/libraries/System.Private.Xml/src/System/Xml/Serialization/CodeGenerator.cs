...
namespace System.Xml.Serialization
{
    internal sealed class CodeGenerator
    {
        ...
        [RequiresDynamicCode(XmlSerializer.AotSerializationWarning)]
        internal static AssemblyBuilder CreateAssemblyBuilder(string name, bool runAndCollect = false)
        {
            AssemblyName assemblyName = new AssemblyName();
            assemblyName.Name = name;
            assemblyName.Version = new Version(1, 0, 0, 0);
            return AssemblyBuilder.DefineDynamicAssembly(assemblyName, runAndCollect ? AssemblyBuilderAccess.RunAndCollect : AssemblyBuilderAccess.Run);
        }
